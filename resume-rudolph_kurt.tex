...
\vspace{-5mm}
  \begin{itemize}
    ...
    \item Support finicial exchange build on a \href{http://www.rabbitmq.com/}{RabbitMQ} core (an \href{http://www.erlang.org/}{Erlang} library) and ruby on rails back end.
    \item Corrdinate with control center professionals to improve product useability and reliability.
  \end{itemize}
